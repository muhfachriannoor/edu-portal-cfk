                ...
                <div class="border border-gray-200 dark:border-gray-700 rounded-lg p-5 bg-gray-50 dark:bg-gray-700">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="grid grid-cols-2">
                            ...
                            <span class="text-base font-semibold text-gray-800 dark:text-gray-100 text-right">{{ $address->province ?? '-' }}</span>
                        </div>

                        {{-- City --}}
                        <div class="grid grid-cols-2">
                            <span class="text-sm font-normal text-gray-500 dark:text-gray-400">City</span>
                            <span class="text-base font-semibold text-gray-800 dark:text-gray-100 text-right">{{ $address->city ?? '-' }}</span>
                        </div>
