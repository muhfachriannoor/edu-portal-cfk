    ...
    <div class="mb-6 dark:bg-gray-900 dark:text-white">
        ...
        <div 
            ...
            <form action="{{ $pageMeta['url'] }}" method="post" enctype="multipart/form-data" accept-charset="UTF-8" data-mode="{{ $mode }}" novalidate>
                ...
                <div>
                    {{-- General Section --}}
                    @include('cms.master_product.section.detail')
                    
                    @include('cms.master_product.section.images')
                    
                    @include('cms.master_product.section.product')

                    @include('cms.master_product.section.seo')
                </div>

                <!-- Card Footer -->
                <x-form.footer
                    :mode="$mode" 
                    :editUrl='optional($product)->id ? route("secretgate19.{$resourceName}.edit", $product->id) : null'  
