...
<head>
  ...
  <title>Reminder Pembayaran Pickup</title>
        ...
        <table cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width: 600px; width: 100%;">
          ...
          <tr>
            <td align="center" style="padding:1.5rem 1.5rem 0">
              <img src="{{ isset($message) ? $message->embed(public_path('assets/img/favicons/logo_sarinah_email.png')) : asset('assets/img/favicons/logo_sarinah_email.png') }}" width="150" alt="Logo Sarinah">
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding:1.5rem">
              <h2 style="margin-top:0 !important; margin-bottom: 0.5rem !important; line-height: 1 !important;">
                Pesanan Anda masih <br>
                menunggu pembayaran
              </h2>
              <p style="color:rgba(0, 0, 0, 0.60);line-height:1.5; font-size: 0.9rem !important;">
                  Halo {{ $model->user->name ?? $model->buyer_name }}, pesanan #{{$model->order_number }} masih menunggu pembayaran. Sisa waktu pembayaran <span style="color:#D71920">1 jam lagi</span> sebelum pesanan otomatis dibatalkan. 
              </p>
            </td>
          </tr>
              ...
              <table width="100%" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="80" height="80" valign="top">
                    @php
                        $imagePath = public_path(str_replace(config('app.url'), '', $item->productVariant?->product?->file_url));
                    @endphp
                    <img src="{{ (isset($message) && file_exists($imagePath)) ? $message->embed($imagePath) : ($item->productVariant?->product?->file_url) }}" 
            ...
            <td style="padding:1.5rem">
              <table width="100%" cellpadding="0" cellspacing="0" style="line-height: 1.8 !important;">
                ...
                <tr>
                  ...
                  <td align="right">
                    <p class="{{ $model->delivery_cost == 0 ? 'free-delivery' : '' }}">
                ...
                <tr>
                  ...
                  <td align="right">
                    <p style="color:#d71920;">
                      <strong>- Rp{{ number_format(($model->discount + $model->discount_voucher), 0, ',', '.') }}</strong>
                    </p>
                  </td>
                </tr>
                @endif
                ...
                <tr>
                  ...
                  <td align="right">
                    <p><strong>Rp{{ number_format($model->other_fees, 0, ',', '.') }}</strong></p></td>
                  </td>
                </tr>
                @endif
              </table>
          ...
          <tr>
            <td style="padding:1.5rem; line-height: 1.4 !important;">
              ...
              <p style="margin-bottom: 0.5rem !important;">
                <strong>
                  {{ $model->user->name ?? $model->buyer_name }}
                </strong>
              </p>
              <p style="margin-bottom: 0.5rem !important;">
                {{ $model->phone_number }}
              ...
              <p style="margin-bottom: 0.5rem !important;">
                {{ $model->store->masterLocation->address ?? 'Alamat tidak ditemukan' }}
              </p>
              <p>
                {{
                  $model->store?->masterLocation?->translations?->firstWhere('locale', 'id')->name
                }}
              </p>
            </td>
          </tr>
              ...
              <table cellpadding="0" cellspacing="0" style="padding:1.5rem 0">
                ...
                <tr>
                  <td align="center" style="margin: 6px !important;">
                    <a href="https://facebook.com/sarinah">
                      <span
                  ...
                  <td align="center">
                    <a href="https://instagram.com/sarinah" style="margin:0 0.8rem">
                      <span
                        style="background:#F3F3F3; border-radius:50%; width:20px; height:20px; display:inline-block; text-align:center; padding:12px;">
                  ...
                  <td align="center">
                    <a href="https://tiktok.com/@sarinah">
                      <span
                        style="background:#F3F3F3; border-radius:50%; width:20px; height:20px; display:inline-block; text-align:center; padding:12px;">
