...
<head>
  ...
  <title>Reminder Pembayaran Delivery</title>
                  ...
                  <td align="center" style="margin: 6px !important;">
                    <a href="https://facebook.com/sarinah">
                      <span
                        ...
                        <img
                          src="{{ isset($message) ? $message->embed(public_path('assets/img/favicons/icon_facebook.png')) : asset('assets/img/favicons/icon_facebook.png') }}"
                          alt="Facebook Sarinah"
                  ...
                  <td align="center">
                    <a href="https://instagram.com/sarinah" style="margin:0 0.8rem">
                      <span
                        style="background:#F3F3F3; border-radius:50%; width:20px; height:20px; display:inline-block; text-align:center; padding:12px;">
                        <img
                          src="{{ isset($message) ? $message->embed(public_path('assets/img/favicons/icon_instagram.png')) : asset('assets/img/favicons/icon_instagram.png') }}"
                          alt="Instagram Sarinah"
                          style="vertical-align:middle; display:inline-block; width:100%;height: auto;">
                      </span>
                    </a>
                  </td>
                  <td align="center">
                    <a href="https://tiktok.com/@sarinah">
                      <span
                        style="background:#F3F3F3; border-radius:50%; width:20px; height:20px; display:inline-block; text-align:center; padding:12px;">
                        <img
                          src="{{ isset($message) ? $message->embed(public_path('assets/img/favicons/icon_tiktok.png')) : asset('assets/img/favicons/icon_tiktok.png') }}"
                          alt="TikTok Sarinah" style="vertical-align:middle; display:inline-block; width:100%;height: auto;">
                      </span>
                    </a>
                  </td>
                </tr>
