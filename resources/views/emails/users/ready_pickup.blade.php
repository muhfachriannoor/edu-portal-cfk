        ...
        <table cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width: 600px; width: 100%;">
          ...
          <tr>
            <td align="center" style="padding:1.5rem">
              ...
              <p style="color:rgba(0, 0, 0, 0.60);line-height:1.5; font-size: 0.9rem !important; margin-bottom: 0.5rem !important;">
                Halo {{ $model->user->name ?? $model->buyer_name }}, Pesanan <strong>#{{ $model->order_number }}</strong> sudah siap
                untuk diambil di Sarinah Thamrin.
              </p>
              <p style="color:rgba(0, 0, 0, 0.60);line-height:1.5; font-size: 0.9rem !important;">
                Mohon datang sesuai jam operasional agar pesanan dapat diterima dengan baik. Jika belum diambil, segera lakukan pickup agar tidak terlewat.
              </p>
            </td>
          </tr>
          <tr>
            <td style="padding:1rem 1.5rem;background:#D71920; color:#fff;">
              <p>
                Kode pengambilan Anda: <strong>{{ $model->pickup_number }}</strong>
              </p>
              <p style="color:rgba(255, 255, 255, 0.60)">
                Silakan tunjukkan kode ini saat mengambil pesanan Anda
              </p>
            </td>
          </tr>
