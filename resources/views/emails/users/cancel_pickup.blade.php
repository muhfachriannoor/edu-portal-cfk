...
<head>
  ...
  <title>Pembatalan Pesanan Pickup</title>
          ...
          <tr>
            <td align="center" style="padding:1.5rem">
              ...
              <p style="color:rgba(0, 0, 0, 0.60);line-height:1.5; font-size: 0.9rem !important;">
                Halo {{ $model->user->name ?? $model->buyer_name }}, Kami informasikan bahwa pesanan <strong>#{{
                $model->order_number }}</strong> tidak dapat dilanjutkan.
                Alasan pembatalan: {{ $model->reason }}. Kamu dapat membuat pesanan baru kapan
                saja melalui website kami.
              </p>
            </td>
          </tr>
