...
<head>
  ...
  <title>Pembatalan Pesanan Delivery</title>
          ...
          <tr>
            <td align="center" style="padding:1.5rem">
              ...
              <p style="color:rgba(0, 0, 0, 0.60);line-height:1.5; font-size: 0.9rem !important;">
                Halo {{ $model->user->name ?? $model->buyer_name }}, Kami informasikan bahwa pesanan #{{
                $model->order_number }} tidak dapat dilanjutkan.
