...
<head>
  ...
  <title>Pembayaran Dikonfirmasi Pickup</title>
      ...
      <td align="center">
        ...
        <table cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width: 600px; width: 100%;">
          ...
          <tr>
            <td align="center" style="padding:1.5rem">
              ...
              <p style="color:rgba(0, 0, 0, 0.60);line-height:1.5; font-size: 0.9rem !important;">
                Halo {{ $model->user->name ?? $model->buyer_name }}, Pembayaran untuk pesanan <strong>#{{
                $model->order_number }}</strong> telah kami terima dan berhasil dikonfirmasi. Pesanan kamu akan
                segera diproses
                oleh penjual. Silakan pantau status pesanan melalui akun kamu.
              </p>
            </td>
          </tr>
         ...
         <tr>
                ...
                <tr>
                  ...
                  <td align="right">
                    <p style="{{ $model->delivery_cost == 0 ? 'color:#218037;' : '' }}">
                      <strong>{{ $model->delivery_cost == 0 ? 'Gratis' : 'Rp' . number_format($model->delivery_cost, 0, ',', '.') }}</strong>
                    </p>
                  </td>
                </tr>
          ...
          <tr>
            <td colspan="2" align="center" style="padding:0.5rem 1.5rem 0">
              <a href="{{ $invoiceUrl }}" style="color:#D71920;text-decoration:none; width: 100%;
                      padding:1rem 0;
                      display:inline-block;">
                <img src="{{ isset($message) ? $message->embed(public_path('assets/img/favicons/icon_download.png')) : asset('assets/img/favicons/icon_download.png') }}" alt="Faktur Pembayaran"
                  style="vertical-align:middle; display:inline-block; width:20px;height: auto; margin-bottom: 4px;">
                <u>Unduh Faktur</u>
              </a>
            </td>
          </tr>
          ...
          <tr>
            <td align="center" style="padding:1rem 1.5rem;">
              ...
              <table cellpadding="0" cellspacing="0" style="padding:24px 0">
