...
<head>
  ...
  <title>Pesanan Sedang Dalam Perjalanan</title>
    ...
    <tr>
      <td align="center">
        ...
        <table cellpadding="0" cellspacing="0" style="background:#ffffff;border-radius:8px;overflow:hidden;max-width: 600px; width: 100%;">
          ...
          <tr>
            <td align="center" style="padding:1.5rem">
              ...
              <p style="color:rgba(0, 0, 0, 0.60);line-height:1.5; font-size: 0.9rem !important;">
                ...
                $model->order_number }}</strong> Anda sedang dalam perjalanan. Anda dapat melacak pesanan Anda di detail pesanan
              </p>
            </td>
          </tr>
          ...
          <!-- Button -->
          <tr>
            <td colspan="2" align="center" style="padding:1rem 2.5rem 0">
