          ...
          <tr>
            <td align="center" style="padding:1.5rem">
              <h2 style="margin-top:0 !important; margin-bottom: 0.5rem !important; line-height: 1 !important;">
                Stok tersedia kembali! <br>
                Pesan sekarang
              </h2>
              <p style="color:rgba(0, 0, 0, 0.60);line-height:1.5; font-size: 0.9rem !important; margin-bottom: 0.5rem !important;">
              Halo {{ $model->user->name ?? $model->buyer_name }}, kabar baik! Produk favoritmu sudah tersedia kembali. Yuk, segera lakukan pemesanan sebelum kehabisan dan nikmati promo menarik yang sedang berlangsung.  
              </p>
            </td>
          </tr>
