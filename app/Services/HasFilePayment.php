...
trait HasFilePayment
{
    ...
    {
        return $this->morphOne(FilePayment::class, 'fileable');
    }
    ...
    {
        return $this->morphMany(FilePayment::class, 'fileable');
    }
    ...
    protected function removeFiles(Request $request): void
    {
        ...
        $files = FilePayment::whereIn('id', $ids)->get();
        $files->each(function ($file) {
            $file->delete();
